...
buttons = '''<div class="option1"> <button type="button" onclick="logdata.openlog()"> open log  </button> </div>
    <div class="option2"> <button type="button" onclick="logdata.closelog()"> close log  </button> </div>
